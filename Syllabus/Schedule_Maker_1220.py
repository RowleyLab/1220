...
Topics = [['Intermolecular Forces', '10.1', 0.75],
          ['Properties of Liquids', '10.2', 0.75],
          ['Phase Transitions', '10.3', 0.75],
          ['Phase Diagrams', '10.4', 0.75],
          ['The Solid State of Matter', '10.5', 0.75],
          ['Lattice Structures in Crystalline Solids', '10.6', 0.75],
          ['The Dissolution Process', '11.1', 0.75],
          ['Electrolytes', '11.2', 0.75],
          ['Solubilty', '11.3', 0.75],
          ['Colligative Properties', '11.4', 0.75],
          ['Colloids', '11.5', 0.75],
          ['Catch-up/Review Day for Exam 1: Chapters 10 and 11'],
          ['Chemical Reaction Rates', '12.1', 0.75],
          ['Factors Affecting Reaction Rates', '12.2', 0.75],
          ['Rate Laws', '12.3', 0.75],
          ['Integrated Rate Laws', '12.4', 0.75],
          ['Collision Theory', '12.5', 0.75],
          ['Reaction Mechanisms', '12.6', 0.75],
          ['Catalysis', '12.7', 0.75],
          ['Chemical Equilibria', '13.1', 0.75],
          ['Equilibrium Constants', '13.2', 0.75],
          ["Shifting Equilibria: Le Ch\^atelier's Principle", '13.3', 0.75],
          ['Equilibrium Concentrations', '13.4', 0.75],
          ['Catch-up/Review Day for Exam 2: Chapters 12 and 13'],
          ['Brønsted-Lowry Acids and Bases', '14.1', 0.75],
          ['pH and pOH', '14.2', 0.75],
          ['Relative Strengths of Acids and Bases', '14.3', 0.75],
          ['Hydrolysis of Salts', '14.4', 0.75],
          ['Polyprotic Acids', '14.5', 0.75],
          ['Buffers', '14.6', 0.75],
          ['Acid-Base Titrations', '14.7', 0.75],
          ['Precipitation and Dissolution', '15.1', 0.75],
          ['Lewis Acids and Bases', '15.2', 0.75],
          ['Coupled Equilibria', '15.3', 0.75],
          ['Catch-up/Review Day for Exam 3: Chapters 14 and 15'],
          ['Spontaneity', '16.1', 0.75],
          ['Entropy', '16.2', 0.75],
          ['The Second and Third Laws of Thermodynamics', '16.3', 0.75],
          ['Free Energy', '16.4', 0.75],
          ['Review of Redox Chemistry', '17.1', 0.75],
          ['Galvanic Cells', '17.2', 0.75],
          ['Electrode and Cell Potentials', '17.3', 0.75],
          ['Potential, Fee Energy, and Equilibrium', '17.4', 0.75],
          ['Batteries and Fuel Cells', '17.5', 0.75],
          ['Corrosion', '17.6', 0.75],
          ['Electrolysis', '17.7', 0.75],
          ['Catch-up/Review Day for Exam 4: Chapters 16 and 17'],
          # 18-20 are discipline-specific chapters
          ['Nuclear Structure and Stability', '21.1', 0.75],
          ['Nuclear Equations', '21.2', 0.75],
          ['Radioactive Decay', '21.3', 0.75],
          ['Transmutation and Nuclear Energy', '21.4', 0.75],
          ['Uses of Radioisotopes', '21.5', 0.75],
          ['Biological Effects of Radiation', '21.6', 0.75]]
