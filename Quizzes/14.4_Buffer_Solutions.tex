...
\begin{document}
	\begin{center}
		{\large	Quiz 14.4 -- Buffer Solutions}
	\end{center}
	...
	$1.5~g$ of \ch{MgF2(s)} are dissolved in a $100.0~ml$ solution of $0.5~M$ \ch{HF}. Find the $pH$ of the solution
	...
	You want to make a buffer solution with $pH=9.750$ using a \ch{HCN/CN^-} buffer. You have one solution with $\left[\ch{HCN}\right]=0.100~M$ and another with $\left[\ch{CN^-}\right]=0.200~M$ which you can mix together to make the buffer. If you start with $125~ml$ of the \ch{HCN} solution, How many $ml$ of \ch{CN^-} solution should you use?
