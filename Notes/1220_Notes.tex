...
\begin{itemize}
  ...
  \item If we have time, we could talk about the copper system from the Le Ch\^atelier's Principle lab
    ...
    \ch{Cu^{2+}(aq) + 4 NH3(aq) <=> $\left[\right.$Cu(NH3)4$\left.\right]^{2+}$(aq)} \hspace{3em} $K_f=1.7\times10^{13}$
...
\begin{itemize}
  ...
  \item The original definition of entropy is: $\mathrm{d} S = \dfrac{\mathrm{d}q}{T}$
